...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Demo: any non-empty credentials work for customers
    if (email && password.length >= 6) {
      document.cookie = `pawmart_user=${encodeURIComponent(email)}; path=/; max-age=86400`
      router.push('/')
    } else {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-block">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mt-2">PawMart</h1>
          </Link>
